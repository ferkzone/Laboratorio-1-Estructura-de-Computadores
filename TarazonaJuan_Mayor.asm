...
mensaje3: .asciiz "El numero mayor es: "
...
encontrar_maximo:
	...
	lw $t3, 0($t2)         # cargar primer elemento como máximo inicial
...
ciclo_max:
	...
	ble $t4, $t3, skip     # si actual <= máximo, saltar
